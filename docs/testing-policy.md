...
| Installer/package correctness | Native artifact CI — the three `*_packaged_*`/`*_lifecycle` modules in `build.yml`, plus the three graphical-session workflows |
