...
| E2 | Publisher is a **named private person**: Andras Takacs, Budapest, Hungary, `info@privacyfence.eu` (Q2). No street address is published. The JSON-LD `Person` publisher, `/imprint/` and `/privacy/`'s controller section use this name. |
